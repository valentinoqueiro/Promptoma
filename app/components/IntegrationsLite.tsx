...
function RollingIcon({
  ...
  return (
    ...
    <motion.div
      ...
      className="relative h-12 w-12 shrink-0 overflow-hidden rounded-xl bg-white/8 ring-1 ring-white/10"
      ...
      >
        ...
        <motion.div
          ...
          className="
            ...
            sm:bg-gradient-to-br sm:from-white/15 sm:via-white/5 sm:to-transparent
        ...
        >
          ...
          <div
            ...
            className="
              ...
              px-3 py-8 sm:px-6 sm:py-10

              ring-0 sm:ring-1 sm:ring-white/10
          ...
          >
            ...
            <svg aria-hidden className="absolute inset-0 h-full w-full opacity-[0.08] hidden sm:block">
            ...
            <motion.div className="relative mt-8 sm:mt-10 grid gap-3 sm:gap-4 sm:grid-cols-3" variants={fadeUp}>
            ...
            <motion.div className="relative mt-6 sm:mt-8 flex justify-center" variants={fadeUp}>

              <a href="https://n8n.io/integrations" target="blank" className="inline-flex items-center justify-center rounded-xl bg-white/10 px-6 py-3 text-sm font-semibold ring-1 ring-white/20 transition hover:bg-white/15">
